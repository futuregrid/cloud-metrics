...
class amie(GeneratedsSuper):
    ...
    def __init__(self, version=None, request_project_create=None, notify_project_create=None, data_project_create=None, request_account_create=None, notify_account_create=None, data_account_create=None, request_project_resources=None, notify_project_resources=None, request_project_modify=None, notify_project_modify=None, request_user_modify=None, notify_user_modify=None, request_project_inactivate=None, notify_project_inactivate=None, request_project_reactivate=None, notify_project_reactivate=None, request_account_inactivate=None, notify_account_inactivate=None, request_account_reactivate=None, notify_account_reactivate=None, request_user_suspend=None, notify_user_suspend=None, request_user_reactivate=None, notify_user_reactivate=None, notify_project_usage=None, request_user_create=None, notify_user_create=None, notify_person_ids=None, request_person_merge=None, notify_person_duplicate=None, inform_transaction_complete=None, response=None):
        ...
        self.notify_person_ids = notify_person_ids
        self.request_person_merge = request_person_merge
        self.notify_person_duplicate = notify_person_duplicate
    ...
    def get_notify_person_ids(self): return self.notify_person_ids
    def set_notify_person_ids(self, notify_person_ids): self.notify_person_ids = notify_person_ids
    def get_request_person_merge(self): return self.request_person_merge
    def set_request_person_merge(self, request_person_merge): self.request_person_merge = request_person_merge
    def get_notify_person_duplicate(self): return self.notify_person_duplicate
    def set_notify_person_duplicate(self, notify_person_duplicate): self.notify_person_duplicate = notify_person_duplicate
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='amie', fromsubclass_=False, pretty_print=True):
        ...
        if self.notify_person_ids is not None:
            self.notify_person_ids.export(outfile, level, namespace_, name_='notify_person_ids', pretty_print=pretty_print)
        if self.request_person_merge is not None:
            self.request_person_merge.export(outfile, level, namespace_, name_='request_person_merge', pretty_print=pretty_print)
        if self.notify_person_duplicate is not None:
            self.notify_person_duplicate.export(outfile, level, namespace_, name_='notify_person_duplicate', pretty_print=pretty_print)
    ...
    def hasContent_(self):
        if (
            ...
            self.notify_person_ids is not None or
            self.request_person_merge is not None or
            self.notify_person_duplicate is not None or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.notify_person_ids is not None:
            showIndent(outfile, level)
            outfile.write('notify_person_ids=model_.notify_person_idsType(\n')
            self.notify_person_ids.exportLiteral(outfile, level, name_='notify_person_ids')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.request_person_merge is not None:
            showIndent(outfile, level)
            outfile.write('request_person_merge=model_.request_person_mergeType(\n')
            self.request_person_merge.exportLiteral(outfile, level, name_='request_person_merge')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.notify_person_duplicate is not None:
            showIndent(outfile, level)
            outfile.write('notify_person_duplicate=model_.notify_person_duplicateType(\n')
            self.notify_person_duplicate.exportLiteral(outfile, level, name_='notify_person_duplicate')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.inform_transaction_complete is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'notify_person_ids':
            obj_ = notify_person_idsType.factory()
            obj_.build(child_)
            self.set_notify_person_ids(obj_)
        elif nodeName_ == 'request_person_merge':
            obj_ = request_person_mergeType.factory()
            obj_.build(child_)
            self.set_request_person_merge(obj_)
        elif nodeName_ == 'notify_person_duplicate':
            obj_ = notify_person_duplicateType.factory()
            obj_.build(child_)
            self.set_notify_person_duplicate(obj_)
...
class bodyType(GeneratedsSuper):
    ...
    def get_charge_num(self): return self.charge_num
    def set_charge_num(self, charge_num): self.charge_num = charge_num
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='bodyType', fromsubclass_=False, pretty_print=True):
        ...
        if self.charge_num is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%scharge_num>%s</%scharge_num>%s' % (namespace_, self.gds_format_string(quote_xml(self.charge_num).encode(ExternalEncoding), input_name='charge_num'), namespace_, eol_))
    ...
    def hasContent_(self):
        if (
            ...
            self.charge_num is not None or
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.charge_num is not None:
            showIndent(outfile, level)
            outfile.write('charge_num=%s,\n' % quote_python(self.charge_num).encode(ExternalEncoding))
        if self.grant_num is not None:
            showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'charge_num':
            charge_num_ = child_.text
            charge_num_ = self.gds_validate_string(charge_num_, node, 'charge_num')
            self.charge_num = charge_num_
...
class notify_person_idsType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, header=None, body=None):
        self.header = header
        self.body = body
    def factory(*args_, **kwargs_):
        if notify_person_idsType.subclass:
            return notify_person_idsType.subclass(*args_, **kwargs_)
        else:
            return notify_person_idsType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_header(self): return self.header
    def set_header(self, header): self.header = header
    def get_body(self): return self.body
    def set_body(self, body): self.body = body
    def export(self, outfile, level, namespace_='', name_='notify_person_idsType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='notify_person_idsType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='notify_person_idsType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='notify_person_idsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='notify_person_idsType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'header':
            ...
            obj_.build(child_)
            self.set_body(obj_)
# end class notify_person_idsType
...
class bodyType27(GeneratedsSuper):
    ...
    def __init__(self, person_id=None, primary_person_id=None, person_id_list=None, resource_login_list=None, remove_resource_list=None):
        ...
        self.resource_login_list = resource_login_list
        self.remove_resource_list = remove_resource_list
    def factory(*args_, **kwargs_):
    ...
    def get_person_id(self): return self.person_id
    def set_person_id(self, person_id): self.person_id = person_id
    def get_primary_person_id(self): return self.primary_person_id
    def set_primary_person_id(self, primary_person_id): self.primary_person_id = primary_person_id
    def get_person_id_list(self): return self.person_id_list
    def set_person_id_list(self, person_id_list): self.person_id_list = person_id_list
    def get_resource_login_list(self): return self.resource_login_list
    def set_resource_login_list(self, resource_login_list): self.resource_login_list = resource_login_list
    def get_remove_resource_list(self): return self.remove_resource_list
    def set_remove_resource_list(self, remove_resource_list): self.remove_resource_list = remove_resource_list
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='bodyType27', fromsubclass_=False, pretty_print=True):
        ...
        if self.primary_person_id is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sprimary_person_id>%s</%sprimary_person_id>%s' % (namespace_, self.gds_format_string(quote_xml(self.primary_person_id).encode(ExternalEncoding), input_name='primary_person_id'), namespace_, eol_))
        if self.person_id_list is not None:
            self.person_id_list.export(outfile, level, namespace_, name_='person_id_list', pretty_print=pretty_print)
        if self.resource_login_list is not None:
            self.resource_login_list.export(outfile, level, namespace_, name_='resource_login_list', pretty_print=pretty_print)
        if self.remove_resource_list is not None:
            self.remove_resource_list.export(outfile, level, namespace_, name_='remove_resource_list', pretty_print=pretty_print)
    def hasContent_(self):
        if (
            self.person_id is not None or
            self.primary_person_id is not None or
            self.person_id_list is not None or
            self.resource_login_list is not None or
            self.remove_resource_list is not None
            ):
            return True
        else:
            return False
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.primary_person_id is not None:
            showIndent(outfile, level)
            outfile.write('primary_person_id=%s,\n' % quote_python(self.primary_person_id).encode(ExternalEncoding))
        if self.person_id_list is not None:
            showIndent(outfile, level)
            outfile.write('person_id_list=model_.person_id_listType(\n')
            self.person_id_list.exportLiteral(outfile, level, name_='person_id_list')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.resource_login_list is not None:
            showIndent(outfile, level)
            outfile.write('resource_login_list=model_.resource_login_listType2(\n')
            self.resource_login_list.exportLiteral(outfile, level, name_='resource_login_list')
            showIndent(outfile, level)
            outfile.write('),\n')
        if self.remove_resource_list is not None:
            showIndent(outfile, level)
            outfile.write('remove_resource_list=model_.remove_resource_listType(\n')
            self.remove_resource_list.exportLiteral(outfile, level, name_='remove_resource_list')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'person_id':
            person_id_ = child_.text
            person_id_ = self.gds_validate_string(person_id_, node, 'person_id')
            self.person_id = person_id_
        elif nodeName_ == 'primary_person_id':
            primary_person_id_ = child_.text
            primary_person_id_ = self.gds_validate_string(primary_person_id_, node, 'primary_person_id')
            self.primary_person_id = primary_person_id_
        elif nodeName_ == 'person_id_list':
            obj_ = person_id_listType.factory()
            obj_.build(child_)
            self.set_person_id_list(obj_)
        elif nodeName_ == 'resource_login_list':
            obj_ = resource_login_listType2.factory()
            obj_.build(child_)
            self.set_resource_login_list(obj_)
        elif nodeName_ == 'remove_resource_list':
            obj_ = remove_resource_listType.factory()
            obj_.build(child_)
            self.set_remove_resource_list(obj_)
# end class bodyType27


class person_id_listType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, person_id=None):
        if person_id is None:
            ...
            self.person_id = person_id
    def factory(*args_, **kwargs_):
        if person_id_listType.subclass:
            return person_id_listType.subclass(*args_, **kwargs_)
        else:
            return person_id_listType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_person_id(self): return self.person_id
    def set_person_id(self, person_id): self.person_id = person_id
    def add_person_id(self, value): self.person_id.append(value)
    def insert_person_id(self, index, value): self.person_id[index] = value
    def export(self, outfile, level, namespace_='', name_='person_id_listType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='person_id_listType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='person_id_listType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='person_id_listType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for person_id_ in self.person_id:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sperson_id>%s</%sperson_id>%s' % (namespace_, self.gds_format_string(quote_xml(person_id_).encode(ExternalEncoding), input_name='person_id'), namespace_, eol_))
    def hasContent_(self):
        if (
            self.person_id
            ):
            ...
            return False
    def exportLiteral(self, outfile, level, name_='person_id_listType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        showIndent(outfile, level)
        outfile.write('person_id=[\n')
        level += 1
        for person_id_ in self.person_id:
            showIndent(outfile, level)
            outfile.write('%s,\n' % quote_python(person_id_).encode(ExternalEncoding))
        level -= 1
        showIndent(outfile, level)
        outfile.write('],\n')
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'person_id':
            person_id_ = child_.text
            person_id_ = self.gds_validate_string(person_id_, node, 'person_id')
            self.person_id.append(person_id_)
# end class person_id_listType


class resource_login_listType2(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, resource_login=None):
        if resource_login is None:
            ...
            self.resource_login = resource_login
    def factory(*args_, **kwargs_):
        if resource_login_listType2.subclass:
            return resource_login_listType2.subclass(*args_, **kwargs_)
        else:
            return resource_login_listType2(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_resource_login(self): return self.resource_login
    def set_resource_login(self, resource_login): self.resource_login = resource_login
    def add_resource_login(self, value): self.resource_login.append(value)
    def insert_resource_login(self, index, value): self.resource_login[index] = value
    def export(self, outfile, level, namespace_='', name_='resource_login_listType2', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='resource_login_listType2')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='resource_login_listType2'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='resource_login_listType2', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='resource_login_listType2'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'resource_login':
            ...
            obj_.build(child_)
            self.resource_login.append(obj_)
# end class resource_login_listType2


class remove_resource_listType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, resource=None):
        if resource is None:
            ...
            self.resource = resource
    def factory(*args_, **kwargs_):
        if remove_resource_listType.subclass:
            return remove_resource_listType.subclass(*args_, **kwargs_)
        else:
            return remove_resource_listType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_resource(self): return self.resource
    def set_resource(self, resource): self.resource = resource
    def add_resource(self, value): self.resource.append(value)
    def insert_resource(self, index, value): self.resource[index] = value
    def export(self, outfile, level, namespace_='', name_='remove_resource_listType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='remove_resource_listType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='remove_resource_listType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='remove_resource_listType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='remove_resource_listType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'resource':
            ...
            resource_ = self.gds_validate_string(resource_, node, 'resource')
            self.resource.append(resource_)
# end class remove_resource_listType


class request_person_mergeType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, header=None, body=None):
        self.header = header
        self.body = body
    def factory(*args_, **kwargs_):
        if request_person_mergeType.subclass:
            return request_person_mergeType.subclass(*args_, **kwargs_)
        else:
            return request_person_mergeType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_header(self): return self.header
    def set_header(self, header): self.header = header
    def get_body(self): return self.body
    def set_body(self, body): self.body = body
    def export(self, outfile, level, namespace_='', name_='request_person_mergeType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='request_person_mergeType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='request_person_mergeType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='request_person_mergeType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='request_person_mergeType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.body is not None:
            showIndent(outfile, level)
            outfile.write('body=model_.bodyType28(\n')
            self.body.exportLiteral(outfile, level, name_='body')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'header':
            ...
            obj_ = bodyType28.factory()
            obj_.build(child_)
            self.set_body(obj_)
# end class request_person_mergeType


class bodyType28(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, keep_global_id=None, keep_person_id=None, keep_portal_login=None, delete_global_id=None, delete_person_id=None, delete_portal_login=None):
        self.keep_global_id = keep_global_id
        self.keep_person_id = keep_person_id
        self.keep_portal_login = keep_portal_login
        self.delete_global_id = delete_global_id
        self.delete_person_id = delete_person_id
        self.delete_portal_login = delete_portal_login
    def factory(*args_, **kwargs_):
        if bodyType28.subclass:
            return bodyType28.subclass(*args_, **kwargs_)
        else:
            return bodyType28(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_keep_global_id(self): return self.keep_global_id
    def set_keep_global_id(self, keep_global_id): self.keep_global_id = keep_global_id
    def get_keep_person_id(self): return self.keep_person_id
    def set_keep_person_id(self, keep_person_id): self.keep_person_id = keep_person_id
    def get_keep_portal_login(self): return self.keep_portal_login
    def set_keep_portal_login(self, keep_portal_login): self.keep_portal_login = keep_portal_login
    def get_delete_global_id(self): return self.delete_global_id
    def set_delete_global_id(self, delete_global_id): self.delete_global_id = delete_global_id
    def get_delete_person_id(self): return self.delete_person_id
    def set_delete_person_id(self, delete_person_id): self.delete_person_id = delete_person_id
    def get_delete_portal_login(self): return self.delete_portal_login
    def set_delete_portal_login(self, delete_portal_login): self.delete_portal_login = delete_portal_login
    def export(self, outfile, level, namespace_='', name_='bodyType28', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='bodyType28')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='bodyType28'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='bodyType28', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.keep_global_id is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%skeep_global_id>%s</%skeep_global_id>%s' % (namespace_, self.gds_format_string(quote_xml(self.keep_global_id).encode(ExternalEncoding), input_name='keep_global_id'), namespace_, eol_))
        if self.keep_person_id is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%skeep_person_id>%s</%skeep_person_id>%s' % (namespace_, self.gds_format_string(quote_xml(self.keep_person_id).encode(ExternalEncoding), input_name='keep_person_id'), namespace_, eol_))
        if self.keep_portal_login is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%skeep_portal_login>%s</%skeep_portal_login>%s' % (namespace_, self.gds_format_string(quote_xml(self.keep_portal_login).encode(ExternalEncoding), input_name='keep_portal_login'), namespace_, eol_))
        if self.delete_global_id is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdelete_global_id>%s</%sdelete_global_id>%s' % (namespace_, self.gds_format_string(quote_xml(self.delete_global_id).encode(ExternalEncoding), input_name='delete_global_id'), namespace_, eol_))
        if self.delete_person_id is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdelete_person_id>%s</%sdelete_person_id>%s' % (namespace_, self.gds_format_string(quote_xml(self.delete_person_id).encode(ExternalEncoding), input_name='delete_person_id'), namespace_, eol_))
        if self.delete_portal_login is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sdelete_portal_login>%s</%sdelete_portal_login>%s' % (namespace_, self.gds_format_string(quote_xml(self.delete_portal_login).encode(ExternalEncoding), input_name='delete_portal_login'), namespace_, eol_))
    def hasContent_(self):
        if (
            self.keep_global_id is not None or
            self.keep_person_id is not None or
            self.keep_portal_login is not None or
            self.delete_global_id is not None or
            self.delete_person_id is not None or
            self.delete_portal_login is not None
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='bodyType28'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.keep_global_id is not None:
            showIndent(outfile, level)
            outfile.write('keep_global_id=%s,\n' % quote_python(self.keep_global_id).encode(ExternalEncoding))
        if self.keep_person_id is not None:
            showIndent(outfile, level)
            outfile.write('keep_person_id=%s,\n' % quote_python(self.keep_person_id).encode(ExternalEncoding))
        if self.keep_portal_login is not None:
            showIndent(outfile, level)
            outfile.write('keep_portal_login=%s,\n' % quote_python(self.keep_portal_login).encode(ExternalEncoding))
        if self.delete_global_id is not None:
            showIndent(outfile, level)
            outfile.write('delete_global_id=%s,\n' % quote_python(self.delete_global_id).encode(ExternalEncoding))
        if self.delete_person_id is not None:
            showIndent(outfile, level)
            outfile.write('delete_person_id=%s,\n' % quote_python(self.delete_person_id).encode(ExternalEncoding))
        if self.delete_portal_login is not None:
            showIndent(outfile, level)
            outfile.write('delete_portal_login=%s,\n' % quote_python(self.delete_portal_login).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'keep_global_id':
            keep_global_id_ = child_.text
            keep_global_id_ = self.gds_validate_string(keep_global_id_, node, 'keep_global_id')
            self.keep_global_id = keep_global_id_
        elif nodeName_ == 'keep_person_id':
            keep_person_id_ = child_.text
            keep_person_id_ = self.gds_validate_string(keep_person_id_, node, 'keep_person_id')
            self.keep_person_id = keep_person_id_
        elif nodeName_ == 'keep_portal_login':
            keep_portal_login_ = child_.text
            keep_portal_login_ = self.gds_validate_string(keep_portal_login_, node, 'keep_portal_login')
            self.keep_portal_login = keep_portal_login_
        elif nodeName_ == 'delete_global_id':
            delete_global_id_ = child_.text
            delete_global_id_ = self.gds_validate_string(delete_global_id_, node, 'delete_global_id')
            self.delete_global_id = delete_global_id_
        elif nodeName_ == 'delete_person_id':
            delete_person_id_ = child_.text
            delete_person_id_ = self.gds_validate_string(delete_person_id_, node, 'delete_person_id')
            self.delete_person_id = delete_person_id_
        elif nodeName_ == 'delete_portal_login':
            delete_portal_login_ = child_.text
            delete_portal_login_ = self.gds_validate_string(delete_portal_login_, node, 'delete_portal_login')
            self.delete_portal_login = delete_portal_login_
# end class bodyType28


class notify_person_duplicateType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, header=None, body=None):
        self.header = header
        self.body = body
    def factory(*args_, **kwargs_):
        if notify_person_duplicateType.subclass:
            return notify_person_duplicateType.subclass(*args_, **kwargs_)
        else:
            return notify_person_duplicateType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_header(self): return self.header
    def set_header(self, header): self.header = header
    def get_body(self): return self.body
    def set_body(self, body): self.body = body
    def export(self, outfile, level, namespace_='', name_='notify_person_duplicateType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='notify_person_duplicateType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='notify_person_duplicateType'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='notify_person_duplicateType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='notify_person_duplicateType'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.body is not None:
            showIndent(outfile, level)
            outfile.write('body=model_.bodyType29(\n')
            self.body.exportLiteral(outfile, level, name_='body')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'header':
            ...
            obj_ = bodyType29.factory()
            obj_.build(child_)
            self.set_body(obj_)
# end class notify_person_duplicateType


class bodyType29(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, person_id1=None, person_id2=None, global_id1=None, global_id2=None):
        self.person_id1 = person_id1
        self.person_id2 = person_id2
        self.global_id1 = global_id1
        self.global_id2 = global_id2
    def factory(*args_, **kwargs_):
        if bodyType29.subclass:
            return bodyType29.subclass(*args_, **kwargs_)
        else:
            return bodyType29(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_person_id1(self): return self.person_id1
    def set_person_id1(self, person_id1): self.person_id1 = person_id1
    def get_person_id2(self): return self.person_id2
    def set_person_id2(self, person_id2): self.person_id2 = person_id2
    def get_global_id1(self): return self.global_id1
    def set_global_id1(self, global_id1): self.global_id1 = global_id1
    def get_global_id2(self): return self.global_id2
    def set_global_id2(self, global_id2): self.global_id2 = global_id2
    def export(self, outfile, level, namespace_='', name_='bodyType29', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='bodyType29')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='bodyType29'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='bodyType29', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.person_id1 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sperson_id1>%s</%sperson_id1>%s' % (namespace_, self.gds_format_string(quote_xml(self.person_id1).encode(ExternalEncoding), input_name='person_id1'), namespace_, eol_))
        if self.person_id2 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sperson_id2>%s</%sperson_id2>%s' % (namespace_, self.gds_format_string(quote_xml(self.person_id2).encode(ExternalEncoding), input_name='person_id2'), namespace_, eol_))
        if self.global_id1 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sglobal_id1>%s</%sglobal_id1>%s' % (namespace_, self.gds_format_string(quote_xml(self.global_id1).encode(ExternalEncoding), input_name='global_id1'), namespace_, eol_))
        if self.global_id2 is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sglobal_id2>%s</%sglobal_id2>%s' % (namespace_, self.gds_format_string(quote_xml(self.global_id2).encode(ExternalEncoding), input_name='global_id2'), namespace_, eol_))
    def hasContent_(self):
        if (
            self.person_id1 is not None or
            self.person_id2 is not None or
            self.global_id1 is not None or
            self.global_id2 is not None
            ):
            return True
        else:
            return False
    def exportLiteral(self, outfile, level, name_='bodyType29'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        if self.person_id1 is not None:
            showIndent(outfile, level)
            outfile.write('person_id1=%s,\n' % quote_python(self.person_id1).encode(ExternalEncoding))
        if self.person_id2 is not None:
            showIndent(outfile, level)
            outfile.write('person_id2=%s,\n' % quote_python(self.person_id2).encode(ExternalEncoding))
        if self.global_id1 is not None:
            showIndent(outfile, level)
            outfile.write('global_id1=%s,\n' % quote_python(self.global_id1).encode(ExternalEncoding))
        if self.global_id2 is not None:
            showIndent(outfile, level)
            outfile.write('global_id2=%s,\n' % quote_python(self.global_id2).encode(ExternalEncoding))
    def build(self, node):
        self.buildAttributes(node, node.attrib, [])
        for child in node:
            nodeName_ = Tag_pattern_.match(child.tag).groups()[-1]
    ...
    def buildAttributes(self, node, attrs, already_processed):
        pass
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'person_id1':
            person_id1_ = child_.text
            person_id1_ = self.gds_validate_string(person_id1_, node, 'person_id1')
            self.person_id1 = person_id1_
        elif nodeName_ == 'person_id2':
            person_id2_ = child_.text
            person_id2_ = self.gds_validate_string(person_id2_, node, 'person_id2')
            self.person_id2 = person_id2_
        elif nodeName_ == 'global_id1':
            global_id1_ = child_.text
            global_id1_ = self.gds_validate_string(global_id1_, node, 'global_id1')
            self.global_id1 = global_id1_
        elif nodeName_ == 'global_id2':
            global_id2_ = child_.text
            global_id2_ = self.gds_validate_string(global_id2_, node, 'global_id2')
            self.global_id2 = global_id2_
# end class bodyType29
...
class inform_transaction_completeType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        if self.body is not None:
            showIndent(outfile, level)
            outfile.write('body=model_.bodyType30(\n')
            self.body.exportLiteral(outfile, level, name_='body')
            showIndent(outfile, level)
            outfile.write('),\n')
    def build(self, node):
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'header':
            ...
            obj_ = bodyType30.factory()
            obj_.build(child_)
            self.set_body(obj_)
# end class inform_transaction_completeType


class bodyType30(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, message=None, status_code=None, detail_code=None):
        ...
        self.detail_code = detail_code
    def factory(*args_, **kwargs_):
        if bodyType30.subclass:
            return bodyType30.subclass(*args_, **kwargs_)
        else:
            return bodyType30(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_message(self): return self.message
    def set_message(self, message): self.message = message
    def get_status_code(self): return self.status_code
    ...
    def get_detail_code(self): return self.detail_code
    def set_detail_code(self, detail_code): self.detail_code = detail_code
    def export(self, outfile, level, namespace_='', name_='bodyType30', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = []
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='bodyType30')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_, name_, pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='bodyType30'):
        pass
    def exportChildren(self, outfile, level, namespace_='', name_='bodyType30', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def exportLiteral(self, outfile, level, name_='bodyType30'):
        level += 1
        self.exportLiteralAttributes(outfile, level, [], name_)
        if self.hasContent_():
            self.exportLiteralChildren(outfile, level, name_)
...
__all__ = [
    ...
    "notify_person_duplicateType",
    "notify_person_idsType",
