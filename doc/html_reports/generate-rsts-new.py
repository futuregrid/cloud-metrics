...
class HtmlReportsRSTs:
    ...
    def get_content_quarter(self):
        ...
        main_title = heading1(month_n_year)

        main_title += heading2("Quarterly report ({0})".format(title_of_period))
    ...
    def get_content_monthly(self):
        ...
        main_title += heading2("Monthly report ({0})".format(month_n_year2))
    ...
    def get_content_weekly(self):
        ...
        main_title = heading2 ("{0}-{1}".format(
            self.start_date.strftime("%m/%d/%Y"),
            self.start_date_plus_six.strftime("%m/%d/%Y"))
    ...
    def get_index_header(self):
        ...
        res =   heading1("Cloud Metric Results") + \
