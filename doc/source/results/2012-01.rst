...
.. raw:: html
        ...
        <div style="margin-top:10px;">
	<iframe width="800" height="450" src="data/2012-01/india/eucalyptus/user/sum/columnhighcharts.html" frameborder="0"></iframe>
	</div>
...
.. raw:: html
   ...
   <div style="margin-top:10px;">
   <iframe width="660" height="500" src="data/2012-01/india/eucalyptus/FGGoogleMotionChart.html" frameborder="0"></iframe>
   </div>
   
   Figure 3. Number of VMs submitted per user for January 2012 on India

.. figure:: /data/2012-01/india/eucalyptus/count/linechart.png
     :scale: 80 %

     Figure 4. Total number of VMs launched on India (daily)

.. figure:: /data/2012-01/india/eucalyptus/runtime/linechart.png
     :scale: 80 %
