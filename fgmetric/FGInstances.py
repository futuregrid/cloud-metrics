...
class FGInstances:
    ...
    userinfo = []
    projectinfo = {}
    default_projectinfo = {"ProjectId":None, "Title":None, "Institution":None} #"Completed":None, "ProjectLead":None, "Institution":None, "Department":None", "Keywords":None, "Results":None}
    pp = None
    db = None
    in_the_future = None
    in_the_past = None
